...
<template>
  <GuestLayout>
    ...
    <h1 class="text-center mb-5 font-bold text-xl uppercase">Log in</h1>
    <div class="grid grid-cols-2 gap-3 items-center mx-auto" style="width: 80vw">
      <form @submit.prevent="submit">
        ...
        <div>
          ...
          <Link
            :href="route('register')"
            class="text-sm flex items-center justify-between mt-4"
          >
      ...
      <div
        ...
        class="rounded-xl h-full hidden sm:block"
      ></div>
    </div>
  </GuestLayout>
</template>
